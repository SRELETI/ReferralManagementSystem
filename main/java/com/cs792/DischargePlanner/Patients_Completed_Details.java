...
public class Patients_Completed_Details extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_patients__completed__details);
		...
		progress = (TextView) findViewById(R.id.Completed);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.menu_patients__completed__details, menu);
		return true;
	}
	...
	public void prepareData() {
		...
		Cursor cursor_personal = patient_data.getPatient_Complete(intent_firstName,intent_lastName,intent_status,intent_date);
		if(cursor_personal.moveToFirst()==false) {
			return;
		}


		Cursor cursor_address = patient_Address_data.getPatientAddress(Integer.parseInt(intent_id));
		Cursor cursor_contact = patient_family_data.getPatientAddress(Integer.parseInt(intent_id));
		Cursor cursor_healthData = patient_health_data.getPatientProblems(Integer.parseInt(intent_id));
		Cursor cursor_healthCard = patient_healthCard_data.getPatientAddress(Integer.parseInt(intent_id));
		Cursor cursor_languageData = patient_language_data.getPatientLanguage(Integer.parseInt(intent_id));
		Cursor cursor_serviceData = patient_service_data.getPatient(Integer.parseInt(intent_id));
		Cursor cursor_referralData = patient_referral_data.getReferralDetails(Integer.parseInt(intent_id));
		...
		String complete_date = cursor_personal.getString(cursor_personal.getColumnIndex(PatientDBAdapter.PATIENT_COMPLETION_DATE));

		name.setText(firstName+" "+lastName);
		date_view.setText("Completed On: "+complete_date);
		...
		personal.add("Complete On: "+complete_date);
		...
		String assignedToStr = cursor_referralData.getString(cursor_referralData.getColumnIndex(PatientReferralAdapater.REFERRAL_ASSIGNED_TO));
		...
		assignedTo.setText("Completed By: "+assignedToStr);
